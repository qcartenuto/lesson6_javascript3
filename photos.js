...
function previewFive() {
   ...
   //add or attach the five image to preview
...
function createEventListeners() {
   ...
   //add an event handler to the specified document below (leftarrow)
   //the leftArrow() function will be executed when the user clicks the left navigation arrow button
   
   leftarrow.addEventListener("click", leftArrow, false);
   
   //declare variable for document element with id of rightarrow in the document
   var rightarrow=document.getElementById("rightarrow");
   
   //add event handler to the specified document element (rightarrow)
   //the rightArrow() will executed when user clicks the right navigation arrow
